...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-slate-950 border-t border-slate-900 text-slate-400 py-12 relative">
      <div className="max-w-7xl mx-auto px-6 md:px-12 flex flex-col md:flex-row items-center justify-between gap-6 relative z-10">
        ...
        <div className="text-center md:text-left">
          <span className="bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent font-display font-extrabold tracking-tight text-lg block mb-2">
            Bandaru Devendar
          </span>
          <p className="text-[10px] font-mono text-slate-500 uppercase tracking-wide">
            &copy; {new Date().getFullYear()} Bandaru Devendar. All rights reserved.
          </p>
        </div>
        ...
        <div className="flex items-center gap-4">
          <a
            ...
            className="w-9 h-9 rounded-lg bg-slate-900 border border-slate-800 hover:border-primary/50 text-slate-400 hover:text-white flex items-center justify-center transition-colors"
            aria-label="GitHub"
          >
            <GithubIcon />
          </a>
        ...
        <button
          onClick={scrollToTop}
          className="px-4 py-2 rounded-xl bg-slate-900 border border-slate-800 hover:border-primary/50 text-[10px] font-mono font-bold uppercase tracking-wider text-slate-400 hover:text-white flex items-center gap-2 cursor-pointer transition-colors"
